...
fig = plots.compare_time(
    results_by_scenario,
    plots.get_electric_torque,
    title="TPIM 1.5hp — Comparativo 1 — Conjugados (zoom na entrada da carga)",
    yaxis_title="Torque (N·m)",
    reference_signal=plots.get_load_torque,
    reference_name="Torque de carga (referência)",
    xlim=zoom_xlim,
...
fig = plots.compare_time(
    results_by_scenario,
    plots.get_speed_rpm,
    title="TPIM 1.5hp — Comparativo 1 — Velocidade (zoom na entrada da carga)",
    yaxis_title="Velocidade (RPM)",
    xlim=zoom_xlim,
)
...
fig = plots.compare_time(
    results_by_scenario,
    plots.get_current_a,
    title="TPIM 1.5hp — Comparativo 1 — Corrente de Fase A (zoom na entrada da carga)",
    yaxis_title="Corrente (A)",
    xlim=zoom_xlim,
)
